...
> = ({ navigation, route }) => {
  ...
  return (
    ...
    >
      ...
      >
        Pneumonia Classifier Inc. is committed to ensuring that the app is as
      ...
      >
        The Pneumonia Classifier app stores and processes personal data that you
        ...
        features and it could mean that the Pneumonia Classifier app won’t work
      ...
      >
        You should be aware that there are certain things that Pneumonia
        Classifier Inc. will not take responsibility for. Certain functions of
        ...
        Pneumonia Classifier Inc. cannot take responsibility for the app not
      ...
      >
        Along the same lines, Pneumonia Classifier Inc. cannot always take
        ...
        turn it on to avail the Service, Pneumonia Classifier Inc. cannot accept
        responsibility.
      </Text>
      <Text
        style={[
      ...
      >
        With respect to Pneumonia Classifier Inc.’s responsibility for your use
        ...
        that we can make it available to you. Pneumonia Classifier Inc. accepts
      ...
      >
        ...
        using the app. Pneumonia Classifier Inc. does not promise that it will
